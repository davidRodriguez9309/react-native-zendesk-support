...
Pod::Spec.new do |s|
  ...
  s.source = { :git => 'https://github.com/felipe-cespedes/react-native-zendesk-support.git',  :tag => 'v'+s.version.to_s }
  s.homepage = 'https://github.com/felipe-cespedes/react-native-zendesk-support'
